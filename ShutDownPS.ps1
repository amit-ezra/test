...
[xml]$xmlfile = Get-Content -Path $config_file.Replace
...
Invoke-Sqlcmd -ServerInstance $db_server -Username $db_username -Password $db_password -Database $db_name -InputFile "ShutDownScript.sql"
